          ...
          onEnterRules: [
            {
              ...
              afterText: /^\s*\*\/$/,
              action: {
                indentAction: o.C8.IndentAction.IndentOutdent,
                appendText: " * ",
              },
            },
            {
              beforeText: /^\s*\/\*\*(?!\/)([^\*]|\*(?!\/))*$/,
              action: {
                indentAction: o.C8.IndentAction.None,
                appendText: " * ",
              },
            },
            {
            ...
            {
              beforeText: /^(\t|(\ \ ))*\ \*\/\s*$/,
              action: { indentAction: o.C8.IndentAction.None, removeText: 1 },
            },
          ],
          autoClosingPairs: [
            { open: "{", close: "}" },
