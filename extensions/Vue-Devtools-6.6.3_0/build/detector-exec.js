(() => {
  ...
  (() => {
    var e = o(23236);
    function t(e) {
      window.postMessage({ key: "_vue-devtools-send-message", message: e });
    }
    function n() {
      let e = 1e3,
        o = 10;
      function n() {
        ...
        if (_) {
          ...
          return (
            window.$nuxt &&
              (e = window.$nuxt.$root && window.$nuxt.$root.constructor),
            void t(
              {
                devtoolsEnabled:
                  (e && e.config.devtools) ||
        ...
        if (s) {
          ...
          t({ devtoolsEnabled: e.config.devtools, vueDetected: !0 }, "*");
        } else
          o > 0 &&
            (o--,
            setTimeout(() => {
    ...
    document instanceof HTMLDocument && (n(), (0, e.w)());
  })();
})();
