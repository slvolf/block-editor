...
(self["webpackChunk_vue_devtools_shell_chrome"] =
  ...
  {
    80440: (e, t, n) => {
      n.r(t), n.d(t, { setupMode: () => ln, setupMode1: () => sn });
      var i,
        r,
        a,
        o,
          ...
          return (
            ...
            (e.prototype._getClient = function () {
              return (
                ...
                this._client ||
                  ((this._worker = A.O0.createWebWorker({
      ...
      (function (e) {
        ...
        (function (e) {
          function t(e, t, n, i) {
            if (
              ...
              return { start: a.create(e, t), end: a.create(n, i) };
        ...
        (function (e) {
          ...
          function n(e) {
            var t = e;
            return (
              me.numberRange(t.red, 0, 1) &&
              me.numberRange(t.green, 0, 1) &&
              me.numberRange(t.blue, 0, 1) &&
              me.numberRange(t.alpha, 0, 1)
            );
          }
          (e.create = t), (e.is = n);
        })(c || (c = {})),
        (function (e) {
          ...
          function n(e) {
            var t = e;
            return o.is(t.range) && c.is(t.color);
          }
          (e.create = t), (e.is = n);
        })(h || (h = {})),
        (function (e) {
          ...
          function n(e) {
            ...
            return (
              me.string(t.label) &&
              (me.undefined(t.textEdit) || v.is(t)) &&
              (me.undefined(t.additionalTextEdits) ||
                me.typedArray(t.additionalTextEdits, v.is))
            );
          }
          (e.create = t), (e.is = n);
        })(d || (d = {})),
        ...
        (function (e) {
          function t(e, t, n, i, r) {
            ...
            return (
              me.defined(n) && (a.startCharacter = n),
              me.defined(i) && (a.endCharacter = i),
              me.defined(r) && (a.kind = r),
              a
            );
          }
          function n(e) {
            var t = e;
            return (
              me.uinteger(t.startLine) &&
              me.uinteger(t.startLine) &&
              (me.undefined(t.startCharacter) ||
                me.uinteger(t.startCharacter)) &&
        ...
        (function (e) {
          ...
          function n(e) {
            var t = e;
            return me.defined(t) && s.is(t.location) && me.string(t.message);
          }
          (e.create = t), (e.is = n);
        })(m || (m = {})),
        (function (e) {
        ...
        (function (e) {
          function t(e) {
            var t = e;
            return void 0 !== t && null !== t && me.string(t.href);
          }
          e.is = t;
        })(b || (b = {})),
        (function (e) {
          function t(e, t, n, i, r, a) {
            ...
            return (
              me.defined(n) && (o.severity = n),
              me.defined(i) && (o.code = i),
              me.defined(r) && (o.source = r),
              me.defined(a) && (o.relatedInformation = a),
              o
            );
          }
          function n(e) {
            ...
            return (
              ...
              (me.integer(n.code) ||
                me.string(n.code) ||
                me.undefined(n.code)) &&
              (me.undefined(n.codeDescription) ||
                me.string(
                  null === (t = n.codeDescription) || void 0 === t
                    ? void 0
                    : t.href
                )) &&
              (me.string(n.source) || me.undefined(n.source)) &&
              (me.undefined(n.relatedInformation) ||
                me.typedArray(n.relatedInformation, m.is))
            );
          }
          (e.create = t), (e.is = n);
        })(_ || (_ = {})),
        (function (e) {
          function t(e, t) {
            ...
            return me.defined(n) && n.length > 0 && (r.arguments = n), r;
          }
          function n(e) {
            var t = e;
        ...
        (function (e) {
          ...
          function r(e) {
            var t = e;
            return me.objectLiteral(t) && me.string(t.newText) && o.is(t.range);
          }
        ...
        (function (e) {
          ...
          function n(e) {
            ...
            return (
              ...
              me.objectLiteral(t) &&
              me.string(t.label) &&
              (me.boolean(t.needsConfirmation) ||
                void 0 === t.needsConfirmation) &&
              (me.string(t.description) || void 0 === t.description)
            );
          }
          (e.create = t), (e.is = n);
        })(y || (y = {})),
        ...
        (function (e) {
          ...
          function r(e) {
            var t = e;
            return v.is(t) && (y.is(t.annotationId) || T.is(t.annotationId));
          }
          (e.replace = t), (e.insert = n), (e.del = i), (e.is = r);
        })(k || (k = {})),
        (function (e) {
          ...
          (this._textEditChanges = Object.create(null)),
            void 0 !== e
              ? ((this._workspaceEdit = e),
                e.documentChanges
                  ? ((this._changeAnnotations = new ue(e.changeAnnotations)),
            ...
            if (D.is(e)) {
              ...
              if (!n) {
                ...
                this._workspaceEdit.documentChanges.push(r),
                  (n = new de(i, this._changeAnnotations)),
      ...
      (function (e) {
        ...
        (function (e) {
          ...
          function n(e) {
            ...
            return (
              me.defined(t) &&
              me.string(t.uri) &&
              (null === t.version || me.integer(t.version))
            );
          }
          (e.create = t), (e.is = n);
        })(D || (D = {})),
        ...
        (function (e) {
          function t(e) {
            var t = e;
            return me.objectLiteral(e) && P.is(t.kind) && me.string(t.value);
          }
          e.is = t;
        })(N || (N = {})),
        (function (e) {
        ...
        (function (e) {
          ...
          function n(e) {
            var t = e;
            return (
              t && me.string(t.newText) && o.is(t.insert) && o.is(t.replace)
            );
          }
          (e.create = t), (e.is = n);
        })(B || (B = {})),
        ...
        (function (e) {
          function t(e, t) {
            ...
            var r = { label: e };
            return (
              me.defined(t) && (r.documentation = t),
              me.defined(n) ? (r.parameters = n) : (r.parameters = []),
              r
            );
          }
          e.create = t;
        ...
        (function (e) {
          ...
          function n(e) {
            ...
            return (
              me.defined(t) &&
              me.typedArray(t.diagnostics, _.is) &&
        ...
        (function (e) {
          function t(e, t) {
            var n = { range: e };
            return me.defined(t) && (n.data = t), n;
          }
          function n(e) {
            var t = e;
            return (
                ...
                if (e.isIncremental(a)) {
                  ...
                  if (h - c === u.length)
                    ...
                    u.length < 1e4
                      ...
                      : (this._lineOffsets = d =
                          d.slice(0, c + 1).concat(u, d.slice(h + 1)));
            ...
            (e.prototype.getLineOffsets = function () {
              return (
                void 0 === this._lineOffsets &&
                  (this._lineOffsets = ke(this._content, !0)),
                this._lineOffsets
              );
            }),
            (e.prototype.positionAt = function (e) {
      ...
      (function (e) {
        ...
        function n(e, t, n) {
          if (e instanceof ye) return e.update(t, n), e;
          throw new Error(
        ...
        function i(e, t) {
          for (
            ...
            c > r && a.push(n.substring(r, c)),
              l.newText.length && a.push(l.newText),
              (r = e.offsetAt(l.range.end));
          }
        ...
        (function (e) {
          e.LATEST = {
            textDocument: {
              ...
              hover: { contentFormat: [P.Markdown, P.PlainText] },
            },
          };
        })(we || (we = {})),
        (function (e) {
          ...
          return (
            ...
            (e.prototype.skipWhitespace = function () {
              var e = this.advanceWhileChar(function (e) {
                return e === Pe || e === Ne || e === We || e === Oe || e === De;
              });
              return e > 0;
            }),
      ...
      function je(e, t, n, i) {
        ...
        function g() {
          ...
          return n === be.EOS ||
            e !== c.pos() ||
            (i && (n === be.StartTagClose || n === be.EndTagClose))
            ? n
            : (console.log(
        ...
        function b() {
          var e,
            t = c.pos();
          if (c.eos()) return f(t, be.EOS);
          switch (h) {
            case _e.WithinComment:
              return c.advanceIfChars([Ae, Ae, Re])
                ? ((h = _e.WithinContent), f(t, be.EndCommentTag))
                : (c.advanceUntilChars([Ae, Ae, Re]), f(t, be.Comment));
            case _e.WithinDoctype:
              return c.advanceIfChar(Re)
                ? ((h = _e.WithinContent), f(t, be.EndDoctypeTag))
                : (c.advanceUntilChar(Re), f(t, be.Doctype));
            case _e.WithinContent:
              if (c.advanceIfChar(Ce)) {
                if (!c.eos() && c.peekChar() === Ee) {
                  if (c.advanceIfChars([Ee, Ae, Ae]))
                    return (h = _e.WithinComment), f(t, be.StartCommentTag);
                  if (c.advanceIfRegExp(/^!doctype/i))
                    return (h = _e.WithinDoctype), f(t, be.StartDoctypeTag);
                }
                return c.advanceIfChar(ze)
                  ? ((h = _e.AfterOpeningEndTag), f(t, be.EndTagOpen))
                  : ((h = _e.AfterOpeningStartTag), f(t, be.StartTagOpen));
              }
              return c.advanceUntilChar(Ce), f(t, be.Content);
            case _e.AfterOpeningEndTag:
              var n = p();
              return n.length > 0
                ? ((h = _e.WithinEndTag), f(t, be.EndTag))
                : c.skipWhitespace()
                ? f(
                    t,
                    be.Whitespace,
                ...
                : ((h = _e.WithinEndTag),
                  c.advanceUntilChar(Re),
                  t < c.pos()
                    ? f(
                        t,
                        be.Unknown,
                        Le("error.endTagNameExpected", "End tag name expected.")
                      )
                    : b());
            case _e.WithinEndTag:
              if (c.skipWhitespace()) return f(t, be.Whitespace);
              if (c.advanceIfChar(Re))
                return (h = _e.WithinContent), f(t, be.EndTagClose);
              if (i && c.peekChar() === Ce)
                return (
                  (h = _e.WithinContent),
                  f(
              ...
              break;
            case _e.AfterOpeningStartTag:
              return (
                (o = p()),
                (l = void 0),
                (s = void 0),
                o.length > 0
                  ? ((a = !1), (h = _e.WithinTag), f(t, be.StartTag))
                  : c.skipWhitespace()
                  ? f(
                      t,
                      be.Whitespace,
            ...
            case _e.WithinTag:
              return c.skipWhitespace()
                ? ((a = !0), f(t, be.Whitespace))
                : a && ((s = m()), s.length > 0)
                ? ((h = _e.AfterAttributeName),
                  (a = !1),
                  f(t, be.AttributeName))
                : c.advanceIfChars([ze, Re])
                ? ((h = _e.WithinContent), f(t, be.StartTagSelfClose))
                : c.advanceIfChar(Re)
                ? ((h =
                    "script" === o
                      ? l && qe[l]
                        ? _e.WithinContent
                        : _e.WithinScriptContent
                      : "style" === o
                      ? _e.WithinStyleContent
                      : _e.WithinContent),
                  f(t, be.StartTagClose))
                : i && c.peekChar() === Ce
                ? ((h = _e.WithinContent),
                  f(
                    t,
            ...
            case _e.AfterAttributeName:
              return c.skipWhitespace()
                ? ((a = !0), f(t, be.Whitespace))
                : c.advanceIfChar(Ie)
                ? ((h = _e.BeforeAttributeValue), f(t, be.DelimiterAssign))
                : ((h = _e.WithinTag), b());
            case _e.BeforeAttributeValue:
              if (c.skipWhitespace()) return f(t, be.Whitespace);
              ...
              return d === Ue || d === He
                ? (c.advance(1),
                  ...
                  "type" === s &&
                    (l = c.getSource().substring(t + 1, c.pos() - 1)),
                  (h = _e.WithinTag),
                  (a = !1),
                  f(t, be.AttributeValue))
                : ((h = _e.WithinTag), (a = !1), b());
            case _e.WithinScriptContent:
              var u = 1;
              while (!c.eos()) {
                var g = c.advanceIfRegExp(/<!--|-->|<\/?script\s*\/?>?/i);
                if (0 === g.length) return c.goToEnd(), f(t, be.Script);
                if ("\x3c!--" === g) 1 === u && (u = 2);
                else if ("--\x3e" === g) u = 1;
                else if ("/" !== g[1]) 2 === u && (u = 3);
                else {
              ...
              return (
                (h = _e.WithinContent), t < c.pos() ? f(t, be.Script) : b()
              );
            case _e.WithinStyleContent:
              return (
                c.advanceUntilRegExp(/<\/style/i),
                (h = _e.WithinContent),
                t < c.pos() ? f(t, be.Styles) : b()
              );
          }
          return c.advance(1), (h = _e.WithinContent), f(t, be.Unknown, e);
        }
        return {
          scan: g,
      ...
      function nt(e) {
        return (
          !!e &&
          Be(tt, e.toLowerCase(), function (e, t) {
        ...
        ct = (function () {
          ...
          return (
            (e.prototype.onHtmlAttributeValue = function (e) {
              pt(e.tag, e.attribute) && this.atributeCompletions.push(e);
            }),
              ...
              return st(this, void 0, void 0, function () {
                ...
                return lt(this, function (u) {
                  switch (u.label) {
                    ...
                    case 2:
                      return (
                        (s = mt(a.value, o, a.range)),
                        [4, this.providePathSuggestions(a.value, s, e, t)]
                      );
                    case 3:
                      for (l = u.sent(), c = 0, h = l; c < h.length; c++)
                        (d = h[c]), n.items.push(d);
                      u.label = 4;
                    case 4:
                      return i++, [3, 1];
                    case 5:
      ...
      function mt(e, t, n) {
        ...
        if (-1 === r) i = bt(n, 1, -1);
          ...
          var a = t.slice(r + 1),
            s = gt(n.end, -1 - a.length),
            l = a.indexOf(" "),
            c = void 0;
          (c = -1 !== l ? gt(s, l) : gt(n.end, -1)), (i = o.create(s, c));
        }
        return i;
      }
      function ft(e, t, n) {
          ...
          ? ((e += "/"),
            {
              label: e,
              kind: q.Folder,
              textEdit: v.replace(n, e),
              command: {
                title: "Suggest",
                command: "editor.action.triggerSuggest",
              },
            })
          : { label: e, kind: q.File, textEdit: v.replace(n, e) };
      }
      function gt(e, t) {
        return a.create(e.line, e.character + t);
      }
      function bt(e, t, n) {
        var i = gt(e.start, t),
          r = gt(e.end, n);
        ...
        (e.prototype.setCompletionParticipants = function (e) {
          ...
          (e.prototype._doComplete = function (e, t, n, i) {
                ...
                l.forEach(function (e) {
                  e.provideTags().forEach(function (e) {
                    r.items.push({
                      label: e.name,
                      kind: q.Property,
                      documentation: ot(e, void 0, c),
                      textEdit: v.replace(n, e.name),
                      insertTextFormat: j.PlainText,
                    });
                  });
                }),
                r
            ...
            function w(e, t, n) {
              void 0 === n && (n = d);
              var i = g(e, n),
                a = St(h, n, _e.WithinEndTag, be.EndTagClose) ? "" : ">",
                o = u;
              t && (o = o.parent);
              while (o) {
                var s = o.tag;
                if (s && (!o.closed || (o.endTagStart && o.endTagStart > d))) {
                  var p = {
                      label: "/" + s,
                      kind: q.Property,
                      filterText: "/" + s,
                      textEdit: v.replace(i, "/" + s + a),
                      insertTextFormat: j.PlainText,
                    },
                    m = _(o.start),
                    f = _(e - 1);
                  if (null !== m && null !== f && m !== f) {
                    var b = m + "</" + s + a;
                    (p.textEdit = v.replace(g(e - 1 - f.length), b)),
                      (p.filterText = f + "</" + s);
                  }
            ...
            function k(e, t) {
              ...
              while (n < t && "<" !== h[n]) n++;
              var i = g(e, n),
                a = St(h, t, _e.AfterAttributeName, be.DelimiterAssign)
                  ? ""
                  : '="$1"',
                  ...
                  e.provideAttributes(f).forEach(function (e) {
                    if (!o[e.name]) {
                      ...
                      "v" !== e.valueSet &&
                        ...
                        r.items.push({
                          label: e.name,
                          kind: "handler" === e.valueSet ? q.Function : q.Value,
                          documentation: ot(e, void 0, c),
                          textEdit: v.replace(i, n),
                          insertTextFormat: j.Snippet,
                          command: t,
                        });
                    }
            ...
            function x(n, i) {
              var a, o, u;
              if ((void 0 === i && (i = d), d > n && d <= i && Tt(h[n]))) {
                var m = n + 1,
                  b = i;
                i > n && h[i - 1] === h[n] && b--;
                var _ = xt(h, d, m),
                  w = Lt(h, d, b);
                (a = g(_, w)),
                  (u = d >= m && d <= b ? h.substring(m, d) : ""),
                  (o = !1);
              } else (a = g(n, i)), (u = h.substring(n, d)), (o = !0);
              if (s.length > 0)
                for (
                  var y = f.toLowerCase(),
                    T = p.toLowerCase(),
            ...
            function L(e) {
              return d === m.getTokenEnd() &&
                ((C = m.scan()), C === e && m.getTokenOffset() === d)
                ? m.getTokenEnd()
                : d;
            }
            function M() {
            ...
            function E() {
              var e = d - 1,
                n = t.character;
              while (e >= 0 && et(h, e)) e--, n--;
              if (e >= 0 && "&" === h[e]) {
                var i = o.create(a.create(t.line, n - 1), t);
                for (var s in Ge)
                  if (Ke(s, ";")) {
                    var l = "&" + s;
                    r.items.push({
                      ...
                      documentation: yt(
                        "entity.propose",
                        "Character entity representing '" + Ge[s] + "'"
                      ),
                      textEdit: v.replace(i, l),
                      insertTextFormat: j.PlainText,
                    });
                  }
              }
            ...
            function A(e, t) {
              ...
              r.items.push({
                ...
                textEdit: v.replace(n, "!DOCTYPE html>"),
                insertTextFormat: j.PlainText,
              });
            }
            var C = m.scan();
            while (C !== be.EOS && m.getTokenOffset() <= d) {
              switch (C) {
                case be.StartTagOpen:
                  if (m.getTokenEnd() === d) {
                    var R = L(be.StartTag);
                    return 0 === t.line && A(d, R), T(d, R);
                  }
                  break;
                case be.StartTag:
                  ...
                  f = m.getTokenText();
                  break;
                case be.AttributeName:
                  if (m.getTokenOffset() <= d && d <= m.getTokenEnd())
                    return k(m.getTokenOffset(), m.getTokenEnd());
                  p = m.getTokenText();
                  break;
                case be.DelimiterAssign:
                  if (m.getTokenEnd() === d) {
                    R = L(be.AttributeValue);
                    return x(d, R);
                  }
                  break;
                case be.AttributeValue:
                  if (m.getTokenOffset() <= d && d <= m.getTokenEnd())
                    return x(m.getTokenOffset(), m.getTokenEnd());
                  break;
                case be.Whitespace:
                  if (d <= m.getTokenEnd())
                    switch (m.getScannerState()) {
                      case _e.AfterOpeningStartTag:
                        var z = m.getTokenOffset(),
                          I = L(be.StartTag);
                        return T(z, I);
                      case _e.WithinTag:
                      case _e.AfterAttributeName:
                ...
                case be.EndTag:
                  if (d <= m.getTokenEnd()) {
                    var W = m.getTokenOffset() - 1;
                    while (W >= 0) {
                      var D = h.charAt(W);
                      if ("/" === D) return w(W, !1, m.getTokenEnd());
                      if (!kt(D)) break;
                      W--;
                    }
                  }
                  break;
                case be.StartTagClose:
          ...
          (e.prototype.doTagComplete = function (e, t, n) {
            ...
            if (">" === r) {
              ...
              if (
                ...
                var o = je(e.getText(), a.start),
                  s = o.scan();
                while (s !== be.EOS && o.getTokenEnd() <= i) {
                  if (s === be.StartTagClose && o.getTokenEnd() === i)
                    return "$0</" + a.tag + ">";
                  s = o.scan();
                }
              }
              ...
              if (a && a.tag) {
                (o = je(e.getText(), a.start)), (s = o.scan());
                while (s !== be.EOS && o.getTokenEnd() <= i) {
                  if (s === be.EndTagOpen && o.getTokenEnd() === i)
                    return a.tag + ">";
                  s = o.scan();
                }
              }
          ...
          (e.prototype.doesSupportMarkdown = function () {
            ...
            if (!it(this.supportsMarkdown)) {
                  ...
                  (n =
                    null ===
                      (t =
                        null ===
                          (e =
                            this.lsOptions.clientCapabilities.textDocument) ||
                        void 0 === e
                          ? void 0
              ...
              this.supportsMarkdown =
                Array.isArray(i) && -1 !== i.indexOf(P.Markdown);
            }
      ...
      function St(e, t, n, i) {
        var r = je(e, t, n),
          a = r.scan();
        while (a === be.Whitespace) a = r.scan();
        return a === i;
      }
      function xt(e, t, n) {
        while (t > n && !kt(e[t - 1])) t--;
        return t;
      }
      function Lt(e, t, n) {
        while (t < n && !kt(e[t])) t++;
      ...
      (function () {
        ...
        (e.prototype.doHover = function (e, t, n, i) {
          ...
          function f(e, t) {
            ...
            for (var i in Ge) {
              var a = null,
                o = "&" + i;
              if (n === o) {
                var s = Ge[i].charCodeAt(0).toString(16).toUpperCase(),
                  l = "U+";
                if (s.length < 4) {
                  var c = 4 - s.length,
                    h = 0;
                ...
                a = d ? { contents: d, range: t } : null;
              }
              if (a) return (a.contents = r(a.contents)), a;
            }
            return null;
          }
          function g(t, n) {
            var i = je(e.getText(), n),
              r = i.scan();
            while (
              r !== be.EOS &&
          ...
          function b() {
            ...
            if (e >= 0 && "&" === h[e]) {
              ...
              return (
                (s =
                  ";" === h[i]
                    ? o.create(a.create(t.line, n), a.create(t.line, r + 1))
                    : o.create(a.create(t.line, n), a.create(t.line, r))),
                s
              );
            }
            return null;
          ...
          function _(e) {
            ...
            while (t >= 0 && et(e, t)) t--;
            t += 1;
            while (et(e, t)) (n += e[t]), (t += 1);
            return (n += ";"), n;
          }
          if (c.endTagStart && l >= c.endTagStart) {
            var w = g(be.EndTag, c.endTagStart);
            return w ? u(c.tag, w, !1) : null;
          }
          var v = g(be.StartTag, c.start);
          if (v) return u(c.tag, v, !0);
          var y = g(be.AttributeName, c.start);
          if (y) {
            var T = c.tag,
              k = e.getText(y);
            return p(T, k, y);
          ...
          if (S) return f(h, S);
          function x(t, n) {
            var i = je(e.getText(), t),
              r = i.scan(),
              a = void 0;
            while (r !== be.EOS && i.getTokenEnd() <= n)
              (r = i.scan()), r === be.AttributeName && (a = i.getTokenText());
            return a;
          }
          var L = g(be.AttributeValue, c.start);
          if (L) {
            T = c.tag;
            var M = Et(e.getText(L)),
              E = x(c.start, e.offsetAt(L.start));
            if (E) return m(T, E, M, L);
          }
          return null;
        }),
          ...
          (r.prototype.restart = function () {
            ...
            (r.prototype.test = function (e, t) {
              return (
                (t = t || 0),
                (t += this.__position),
                t >= 0 && t < this.__input_length && !!this.__match(e, t)
              );
            }),
                  ...
                  if ((this.preserveSingleSpace(o), "{" === this._input.peek()))
                    ...
                    S.match(/[ :]$/) &&
                      ...
                      S in this.NESTED_AT_RULE
                        ? ((this._nestedLevel += 1),
                          S in this.CONDITIONAL_GROUP_RULE && (_ = !0))
                        : g ||
                          0 !== f ||
                          -1 === S.indexOf(":") ||
                          ((b = !0), this.indent());
                  ...
                  "#" === this._ch && "{" === this._input.peek()
                    ...
                    ? (b && ((b = !1), this.outdent()),
                      _
                        ...
                        : (g = this._indentLevel >= this._nestedLevel - 1),
            ...
            (f.prototype._do_optional_end_element = function (e) {
              ...
              if (!e.is_empty_element && e.is_start_tag && e.parent) {
                if ("body" === e.tag_name)
                  ...
                  "p" === e.parent.tag_name &&
                  -1 !== b.indexOf(e.tag_name)
                ) {
                  var n = e.parent.parent;
                  (n && -1 !== _.indexOf(n.tag_name)) ||
              ...
              (h.prototype._get_next_token = function (e, t) {
                ...
                return null === i
                  ...
                  : ((n = n || this._read_open_handlebars(i, t)),
                    ...
                    (n =
                      n || this._create_token(l.UNKNOWN, this._input.next())),
                    n);
              }),
              (h.prototype._read_comment_or_cdata = function (e) {
                ...
                if ("<" === e) {
                  ...
                  "!" === r &&
                    ...
                    n &&
                      ((t = this._create_token(l.COMMENT, n)),
                      (t.directives = i));
                }
                return t;
              }),
            ...
            470: (e) => {
              ...
              var i = {
                ...
                relative: function (e, n) {
                  ...
                  for (
                    var l = n.length - s, c = o < l ? o : l, h = -1, d = 0;
                    d <= c;
                    ++d
                  ) {
                    if (d === c) {
                  ...
                  return p.length > 0
                    ? p + n.slice(s + h)
                    : ((s += h), 47 === n.charCodeAt(s) && ++s, n.slice(s));
                },
                ...
                parse: function (e) {
                  ...
                  a ? ((n.root = "/"), (i = 1)) : (i = 0);
                  for (
                    var o = -1, s = 0, l = -1, c = !0, h = e.length - 1, d = 0;
                    h >= i;
                    --h
                  )
            ...
            447: (e, t, n) => {
                ...
                g = (function (e) {
                  ...
                  return (
                    ...
                    Object.defineProperty(t.prototype, "fsPath", {
                      get: function () {
                        return (
                          this._fsPath || (this._fsPath = v(this, !1)),
                          this._fsPath
                        );
                      },
                      enumerable: !1,
                    ...
                    (t.prototype.toJSON = function () {
                      ...
                      return (
                        this._fsPath &&
                          ((e.fsPath = this._fsPath), (e._sep = f)),
                ...
                if (o) {
                  if (
                    ...
                    (d = o.charCodeAt(1)) >= 65 &&
                      d <= 90 &&
                      (o =
                        "/" + String.fromCharCode(d + 32) + ":" + o.substr(3));
              ...
              function T(e) {
                try {
                  ...
                  return e.length > 3 ? e.substr(0, 3) + T(e.substr(3)) : e;
                }
              }
              ...
              !(function (e) {
                (e.joinPath = function (e) {
                  for (var t = [], n = 1; n < arguments.length; n++)
                    t[n - 1] = arguments[n];
                  return e.with({ path: E.join.apply(E, M([e.path], t)) });
                }),
                  (e.resolvePath = function (e) {
                    for (var t = [], n = 1; n < arguments.length; n++)
                      t[n - 1] = arguments[n];
                    var i = e.path || "/";
                    return e.with({ path: E.resolve.apply(E, M([i], t)) });
                  }),
      ...
      (function () {
        ...
        (e.prototype.setDataProviders = function (e, t) {
          var n;
          (this.dataProviders = []),
            e && this.dataProviders.push(new at("html5", zt)),
      ...
      var It = (function () {
        function e(e, t, n) {
          ...
          var r = function (e) {
            ...
            a = function (e) {
              A.O0.setModelMarkers(e, i._languageId, []);
              var t = e.uri.toString(),
                n = i._listener[t];
              n && (n.dispose(), delete i._listener[t]);
            };
          this._disposables.push(A.O0.onDidCreateModel(r)),
            this._disposables.push(
              A.O0.onWillDisposeModel(function (e) {
                a(e);
              })
            ),
            this._disposables.push(
              A.O0.onDidChangeModelLanguage(function (e) {
                a(e.model), r(e.model);
              })
            ),
            this._disposables.push(
              n.onDidChange(function (e) {
                A.O0.getModels().forEach(function (e) {
              ...
              .then(function (n) {
                return n.doValidation(e.toString()).then(function (n) {
                  var i = n.map(function (t) {
                    ...
                    r = A.O0.getModel(e);
                  r && r.getModeId() === t && A.O0.setModelMarkers(r, t, i);
                });
              })
      ...
      function Dt(e) {
        if (e)
          return {
            start: Wt(e.getStartPosition()),
            end: Wt(e.getEndPosition()),
          };
      }
      function Ot(e) {
        if (e)
        ...
        return (
          ...
          (e.prototype.provideCompletionItems = function (e, t, n, i) {
            ...
            return this._worker(r)
              .then(function (e) {
                return e.doComplete(r.toString(), Wt(t));
              })
              .then(function (n) {
                if (n) {
                      ...
                      return (
                        e.textEdit &&
                          (Pt(e.textEdit)
                            ...
                            : (t.range = Ot(e.textEdit.range)),
                          (t.insertText = e.textEdit.newText)),
                        e.additionalTextEdits &&
                          (t.additionalTextEdits =
                            e.additionalTextEdits.map(qt)),
                        e.insertTextFormat === j.Snippet &&
                          (t.insertTextRules =
                            A.C8.CompletionItemInsertTextRule.InsertAsSnippet),
                        t
                      );
                    });
        ...
        return (
          (e.prototype.provideHover = function (e, t, n) {
            ...
            return this._worker(i)
              .then(function (e) {
                return e.doHover(i.toString(), Wt(t));
              })
              .then(function (e) {
                if (e) return { range: Ot(e.range), contents: Gt(e.contents) };
              });
          }),
          e
        );
      ...
      function Kt(e) {
        var t = A.C8.DocumentHighlightKind;
        switch (e) {
          case Q.Read:
            return t.Read;
          case Q.Write:
      ...
      var Jt = (function () {
        ...
        return (
          (e.prototype.provideDocumentHighlights = function (e, t, n) {
            ...
            return this._worker(i)
              .then(function (e) {
                return e.findDocumentHighlights(i.toString(), Wt(t));
              })
              .then(function (e) {
                if (e)
                  return e.map(function (e) {
                    return { range: Ot(e.range), kind: Kt(e.kind) };
                  });
              });
          }),
          e
            ...
            (e.prototype.provideDocumentFormattingEdits = function (e, t, n) {
              ...
              return this._worker(i).then(function (e) {
                return e.format(i.toString(), null, Qt(t)).then(function (e) {
                  if (e && 0 !== e.length) return e.map(qt);
                });
              });
            }),
            e
          ...
          return (
            (e.prototype.provideDocumentRangeFormattingEdits = function (
              ...
              return this._worker(r).then(function (e) {
                return e.format(r.toString(), Dt(t), Qt(n)).then(function (e) {
                  if (e && 0 !== e.length) return e.map(qt);
                });
              });
            }),
        ...
        tn = (function () {
          ...
          return (
            (e.prototype.provideRenameEdits = function (e, t, n, i) {
              ...
              return this._worker(r)
                .then(function (e) {
                  return e.doRename(r.toString(), Wt(t), n);
                })
                .then(function (e) {
                  return nn(e);
                });
      ...
      function nn(e) {
        if (e && e.changes) {
          ...
          for (var n in e.changes)
            for (
              var i = A.SK.parse(n), r = 0, a = e.changes[n];
              r < a.length;
              r++
            ) {
              var o = a[r];
              t.push({
                resource: i,
                edit: { range: Ot(o.range), text: o.newText },
              });
            }
          return { edits: t };
        }
              ...
              .then(function (e) {
                if (e)
                  return e.map(function (e) {
                    ...
                    return (
                      "undefined" !== typeof e.kind && (t.kind = an(e.kind)), t
                    );
                  });
              });
          }),
      ...
      function an(e) {
        switch (e) {
          case u.Comment:
            return A.C8.FoldingRangeKind.Comment;
          case u.Imports:
            return A.C8.FoldingRangeKind.Imports;
          case u.Region:
            return A.C8.FoldingRangeKind.Region;
        }
      }
      var on = (function () {
        function e(e) {
        ...
        return (
          (e.prototype.provideSelectionRanges = function (e, t, n) {
            ...
            return this._worker(i)
              .then(function (e) {
                return e.getSelectionRanges(i.toString(), t.map(Wt));
              })
              .then(function (e) {
                if (e)
                  return e.map(function (e) {
                    var t = [];
                    while (e) t.push({ range: Ot(e.range) }), (e = e.parent);
                    return t;
                  });
              });
          }),
      ...
      function sn(e) {
        var t = new R(e),
          ...
          i = e.languageId;
        A.C8.registerCompletionItemProvider(i, new jt(n)),
          A.C8.registerHoverProvider(i, new Vt(n)),
          A.C8.registerDocumentHighlightProvider(i, new Jt(n)),
          A.C8.registerLinkProvider(i, new $t(n)),
          A.C8.registerFoldingRangeProvider(i, new rn(n)),
          A.C8.registerDocumentSymbolProvider(i, new Yt(n)),
          A.C8.registerSelectionRangeProvider(i, new on(n)),
          A.C8.registerRenameProvider(i, new tn(n)),
          "html" === i &&
            (A.C8.registerDocumentFormattingEditProvider(i, new Zt(n)),
            A.C8.registerDocumentRangeFormattingEditProvider(i, new en(n)),
            new It(i, n, e));
      }
      function ln(e) {
        var t = [],
        ...
        function a() {
          ...
          hn(n),
            i.completionItems &&
              n.push(A.C8.registerCompletionItemProvider(t, new jt(r))),
            i.hovers && n.push(A.C8.registerHoverProvider(t, new Vt(r))),
            i.documentHighlights &&
              n.push(A.C8.registerDocumentHighlightProvider(t, new Jt(r))),
            i.links && n.push(A.C8.registerLinkProvider(t, new $t(r))),
            i.documentSymbols &&
              n.push(A.C8.registerDocumentSymbolProvider(t, new Yt(r))),
            i.rename && n.push(A.C8.registerRenameProvider(t, new tn(r))),
            i.foldingRanges &&
              n.push(A.C8.registerFoldingRangeProvider(t, new rn(r))),
            i.selectionRanges &&
              n.push(A.C8.registerSelectionRangeProvider(t, new on(r))),
            i.documentFormattingEdits &&
              n.push(A.C8.registerDocumentFormattingEditProvider(t, new Zt(r))),
            i.documentRangeFormattingEdits &&
              n.push(
                A.C8.registerDocumentRangeFormattingEditProvider(t, new en(r))
              ),
            i.diagnostics && n.push(new It(t, r, e));
        }
        return a(), t.push(cn(n)), cn(t);
      }
      function cn(e) {
        return {
          dispose: function () {
